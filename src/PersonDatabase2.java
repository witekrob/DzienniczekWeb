...
public class PersonDatabase2 implements Readable {
	...
	public void create() {
		...
		System.out.println("podaj imi�?ª : ");
	...
	public static Person2 get1() {
		...
		while (choice != 0) {
			System.out.println("W jaki spos�?³b szukaÄ‡?");
			...
			case 1:
				...
				System.out.println("Podaj imi�?ª osoby do wyÅ“wietlenia");
				String name = input.next();
				...
				if (count == 1) {
					...
					System.out.println("znaleziono wiÄ™cej wynik�?³w o takich danych");
					break;
				}
	...
	public void remove() {
		System.out.println("Podaj nazwisko osoby do usuni�?ªcia z listy");
		String surname = input.next();
		System.out.println("Podaj imiÄ™ osoby do usuni�?ªcia z listy");
		String name = input.next();
		int counter = 0;
		...
		if (counter == 1) {
			...
			System.out.println("znalaziono za duÅ¼o wynik�?³w");
		}
	}
